...
class Next3000FJ(DeviceError):
    ...
    def __init__(self, logger_obj, device_name = "Next3000FJ", ser_port = "COM7"):
    ...
    def _setDisplay(self, value):
        ...
        :param value (int): Speed => 0, Flowrate => 1

        :return: command received value --> (int)
        """
        data_int = self._writeRegister(18,value)
...
if __name__ == "__main__":
    ...
    Device  = Next3000FJ(logger_obj=NodeLogger_obj, ser_port= "COM7")

    
    # time.sleep(10)
    # print(Device._writeRegisters(5, 2, 500))
    # Device._setPumpTube(6)
    # Device._setDirection(1)
    # print(Device._readHoldingRegister(3,1,"16uint"))
    # Device.heartbeat()
    Device.operate(5,300,'real')
    # Device._stop()
