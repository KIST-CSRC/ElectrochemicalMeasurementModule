...
class ParamterTCP:
    ...
    def __init__(self):
        self.HOST_PORT={
            "DS_E":{
                "HOST":"161.122.22.234", # (UBUNTU : PUMP (Syringe pump)) The server's hostname or IP address
                "PORT":54009 # Ubuntu Server
            },
            "PIPETTE":{
                "HOST":"161.122.22.234", # (UBUNTU : PUMP (Syringe pump)) The server's hostname or IP address
                "PORT":54009 # Ubuntu Server
            ...
            "ROBOTTRANSFERUNIT":{
                "HOST":"161.122.22.231", # (UBUNTU : PUMP (Syringe pump)) The server's hostname or IP address
                "PORT":54009 # Ubuntu Server
            },
            # "PUMP":{
            #     "HOST":"161.122.22.232", # (UBUNTU : PUMP (Syringe pump)) The server's hostname or IP address
            #     "PORT":54011 # Ubuntu Server
            # }
        }
...
#     NodeLogger_obj = NodeLogger(platform_name="Evaluation", setLevel="DEBUG",
#                             SAVE_DIR_PATH="Log")
#     DS_E = TCP_Class("DS_E", NodeLogger_obj)
#     print(1)
#     cmd = b'9999/DS_E/place_mobile_holder_to_RTU_HOME/0/real'
#     print(1)
#     DS_E.callServer(command_byte=cmd)