...
class NodeLogger(object):
    ...
    """   
    def __init__(self, platform_name="Electrochemical Analysis Server", setLevel="DEBUG",SAVE_DIR_PATH="C:/Users/KIST/PycharmProjects/BatchPlatform"):
...
if __name__ == "__main__" :
    nod = NodeLogger(platform_name="Electrochemical Analysis", setLevel="DEBUG",
